...
# Per-climb detail rendering is shared with analyse_gpx via
# chart_climb_detail (GPX-tolerant superset of the old local versions).
from chart_climb_detail import (  # noqa: F401
